...
contract Exchange {
    ...
    function depositToken(address _token, uint256 _amount) public {
        ...
        // 调用某个方法强行从你当前账户往当前交易所账户转钱
        require(JackToken(_token).transferFrom(msg.sender, address(this), _amount));
    ...
    function withdrawToken(address _token, uint256 _amount) public {
        ...
        // 把钱从交易所转到自己账户
        require(JackToken(_token).transfer(msg.sender, _amount));
    ...
    function fillOrder(uint256 _id) public {
        ...
        /*
            ...
            myorder.tokenGet: JackToken货币的合约地址
            myorder.tokenGive： 以太币合约地址
        */
